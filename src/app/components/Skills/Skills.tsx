    ...
    <div>
      ...
      <div className="flex flex-col gap-4 bg-white rounded-3xl p-6 pb-7 colors">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <span className="bg-lime-200 text-lime-900 text-sm font-medium px-3 py-1 rounded-full">
            Firebase
          </span>
          <span className="bg-stone-100 text-stone-800 text-sm font-medium px-3 py-1 rounded-full">
            Neo4j
          </span>
          <span className="bg-amber-200 text-amber-900 text-sm font-medium px-3 py-1 rounded-full">
            APIs
          </span>
