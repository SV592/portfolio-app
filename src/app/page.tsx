    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-7xl mx-auto">
        ...
        <div className="md:col-span-8 lg:col-span-9 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {/* Row 1: Small Stat Cards */}
          {/* <div className="lg:col-span-3 xl:col-span-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
            <div className="bg-white rounded-3xl shadow-lg p-6 h-36 flex items-center justify-center text-gray-400">
              Project View Card Placeholder
            </div>
            <div className="bg-white rounded-3xl shadow-lg p-6 h-36 flex items-center justify-center text-gray-400">
              Total Interview Card Placeholder
            </div>
            <div className="bg-white rounded-3xl shadow-lg p-6 h-36 flex items-center justify-center text-gray-400">
              Total Problem Solved Card Placeholder
            </div>
          </div> */}
